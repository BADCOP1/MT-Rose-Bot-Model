        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="👨‍💼 Master", url="t.me/CYBER_YT1"),  InlineKeyboardButton(text="Help 🤔", url="https://t.me/{}?start=help".format(bot.username))],
                     [InlineKeyboardButton(text="🖥️YOUTUBE CHANNEL🖥️", url="https://www.youtube.com/channel/UC4Eorw1OaILIuLgdIBdNE0w")],
    else:
